...
class incomeInfo extends StatefulWidget {
  @override
  _incomeInfoState createState() => _incomeInfoState();
}
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: Text("Zakat on Income", style: TextStyle(fontWeight: FontWeight.w200, fontSize: 30),),
              ),
              ...
              SizedBox(height: 10,),
              Text('2. Haul = 1 year/ 1 month', style: TextStyle(fontWeight: FontWeight.bold),),
              SizedBox(height: 10,),

...
class treasureInfo extends StatefulWidget {
  @override
  _treasureInfoState createState() => _treasureInfoState();
}

class _treasureInfoState extends State<treasureInfo> {
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Align(
                ...
                child: Text("Zakat on Treasure", style: TextStyle(fontWeight: FontWeight.w200, fontSize: 30),),
              ),
